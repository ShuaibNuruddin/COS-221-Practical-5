...
Website Deployment:
**Navigate to the sql folder launch all the sql files in your MariaDB or Mysql workbench
...
**Navigate to the php folder and locate the updatemediaconnection.php, open it with your php ide and fill the   password area with your mysql password, save and close it(Backend info).
** Import the database dumps of the sql files to get the databases onto your computer.
